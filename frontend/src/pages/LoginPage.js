...
function LoginPage() {
  ...
  const { is_authenticated, is_admin, is_student, is_teacher } = useSelector(
    (state) => state.auth
  );
  ...
  return (
    <div
      ...
      // style={{ backgroundImage: "linear-gradient(115deg, #FEE2FE)" }}
    >
          ...
          <div className="flex flex-wrap items-center">
            <div className="hidden w-full xl:block xl:w-1/2">
              <div className="py-17.5 px-26 text-center">
                ...
                {/* Learning is Key, We Open the Door */}
                Building an experience that supports your journey to excellence, ensuring that every milestone is celebrated and every challenge is overcome together.
                </p>
