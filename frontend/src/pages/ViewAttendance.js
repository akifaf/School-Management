...
// import { fetchStudentsByClass } from "../redux/studentSlice"; // Adjust the import based on your setup
...
const ViewAttendance = () => {
  ...
  const student_list = useSelector((state) => state.student.student_list); // Adjust based on your store
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between items-center mb-4 font-bold">
            <div>Class: {selectedClassroom.class_no} {selectedClassroom.section}</div>
