  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <h1 className="text-white bold font-satoshi font-bold text-xl">
            Teacher Dashboard
          </h1>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <hr />
        <nav className="mt-3 py-1 px-4 lg:mt-9 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/take-attendance"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("take-attendance") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
              ...
              <li>
                <NavLink
                  to="/view-attendance"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("view-attendance") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="w-6 h-6 text-gray-800 dark:text-white"
