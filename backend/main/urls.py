...
urlpatterns = [
    ...
    path('teacher-files/delete/<int:file_id>/', TeacherFileDeleteView.as_view(), name='teacher-file-delete'),
    path('teacher-classrooms/', TeacherClassListView.as_view(), name='teacher-classrooms'),
